...
// it out of useAudioBooks.js (which is "use client") matters: any export
// from a "use client" file becomes client-only, and a Server Component
 ...
 * into the exact params object sent to GET /admin/audiobooks. Used by both
 * the SSR page (prefetch) and the client container so their query keys
 * always match, whatever filters/page are in the URL.
 */
export function buildAudioBooksParams(raw = {}) {
