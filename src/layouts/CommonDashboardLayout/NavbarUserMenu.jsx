    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent
                align="end"
                sideOffset={12}
                className="w-64 rounded-[8px] border border-border bg-dark-accent/95 backdrop-blur-md p-2"
            >
                <DropdownMenuItem render={<Link href={href} />} className="gap-3 px-2 py-2 rounded-[8px]">
