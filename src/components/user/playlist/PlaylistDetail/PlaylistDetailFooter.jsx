...
import DeletePlaylistDialog from "@/components/dialogs/user/playlist/DeletePlaylistDialog";

const PlaylistDetailFooter = ({ playlist, onClose }) => {
  return (
    <div className="p-4 border-t border-white/5 mt-auto shrink-0 bg-card">
      <div className="flex items-center justify-between w-full">
        <DeletePlaylistDialog
          playlist={playlist}
          onOpenChange={(isOpen) => {
            // When delete dialog confirms and closes, close detail modal as well
            if (!isOpen) {
              onClose?.();
            }
          }}
...
export default PlaylistDetailFooter;
