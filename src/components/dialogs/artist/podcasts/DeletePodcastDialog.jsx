...
import ArtistDeletePodcastForm from "@/components/forms/podcasts/ArtistDeletePodcastForm"

const DeletePodcastDialog = ({ podcast, children }) => {
...
export default DeletePodcastDialog
