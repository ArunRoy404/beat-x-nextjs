...
import ArtistDeleteProductForm from "@/components/forms/shop/ArtistDeleteProductForm"

const DeleteProductDialog = ({ product, children, onDeleted }) => {
