...
import ArtistDeleteTransactionForm from "@/components/forms/revenue/ArtistDeleteTransactionForm"

const DeleteTransactionDialog = ({ transaction, children }) => {
