...
import AlbumDetailHeader from "@/components/artist/albums/AlbumsDetails/AlbumDetailHeader"
import AlbumDetailsTabs from "@/components/artist/albums/AlbumsDetails/AlbumDetailsTabs"
import AlbumDetailFooter from "@/components/artist/albums/AlbumsDetails/AlbumDetailFooter"
...
const AlbumDetailsDialog = ({ album: initialAlbum, children }) => {
    ...
    const album = useArtistAlbumsStore((state) =>
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="sm:max-w-[672px] p-0 overflow-hidden flex flex-col max-h-[95vh]">
                ...
                {/* Switchable Tabs between Track Listing & Analytics */}
