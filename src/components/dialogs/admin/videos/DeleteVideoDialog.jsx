...
import DeleteVideoForm from "@/components/forms/videos/DeleteVideoForm"

const DeleteVideoDialog = ({ video, children }) => {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="border-white/10 bg-[#1A1A19]">
