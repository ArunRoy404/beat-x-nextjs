  ...
  return (
    ...
    <div className="p-4 flex flex-col gap-5 overflow-y-auto flex-1 min-h-0 scrollbar-thin">
      <div className="grid grid-cols-2 gap-4">
        ...
        <InfoBox label="Full Legal Name" value={artist?.fullName || "Tahsin Ahmed"} />
        <InfoBox label="Stage Name" value={artist?.name || "TAHSIN"} />
        <InfoBox label="Date of Birth" value={artist?.dob || "1995-03-15"} />
        <InfoBox label="Gender" value={artist?.gender || "Male"} />
        <InfoBox label="Nationality" value={artist?.nationality || "Bangladeshi"} />
        <InfoBox label="Primary Language" value={artist?.primaryLanguage || "Bengali"} />
        <InfoBox label="Artist Category" value="Singer" />
        <InfoBox label="ID Document" value="National ID Card" />
