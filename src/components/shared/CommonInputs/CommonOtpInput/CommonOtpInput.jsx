...
const CommonOtpInput = ({ length = 6, value, onChange, error, className, rootClassName, inputClassName, ...props }) => {
    return (
        <div className={cn("flex flex-col gap-1.5 w-full items-center", className)}>
            <OTPField.Root
                ...
                className={cn("flex items-center justify-center gap-2 sm:gap-3 w-full", rootClassName)}
                {...props}
            >
