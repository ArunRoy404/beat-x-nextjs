...
const PodcastsContainer = () => {
  const podcasts = useArtistPodcastsStore((state) => state.podcastsList)
  ...
  const tabs = ["All", "Published", "Under Review", "Scheduled", "Rejected", "Taken Down"]
