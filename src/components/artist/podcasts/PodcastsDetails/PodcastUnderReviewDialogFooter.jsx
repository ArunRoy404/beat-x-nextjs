...
const rejectionReasons = [
    { value: "identity_music_unclear", label: "Identity Music unclear or unreadable" },
...
const PodcastUnderReviewDialogFooter = ({ podcast, startWithRejection = false }) => {
    const [isRejecting, setIsRejecting] = useState(startWithRejection)
    const [adminNote, setAdminNote] = useState("")
    const [rejectionReason, setRejectionReason] = useState("identity_music_unclear")
...
export default PodcastUnderReviewDialogFooter
