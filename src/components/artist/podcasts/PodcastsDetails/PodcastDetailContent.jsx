            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 border border-white/10 bg-white/5 rounded-[16px] p-3 px-4 flex flex-col gap-1.5 w-full">
                    ...
                    <span className="text-[13px] text-whitetext/90 leading-relaxed font-normal">
                        {podcast?.description || `${podcast?.title} — episode ${podcast?.episode || "1"} of ${podcast?.series || "Single"}, season ${podcast?.season || "1"}, hosted by ${podcast?.artist || "TAHSIN"}. Category: ${podcast?.genre || "General"}.`}
                    </span>
                </div>
            </div>
        </div>
