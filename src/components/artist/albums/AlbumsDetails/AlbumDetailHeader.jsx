                ...
                <div className="flex flex-col justify-between min-h-[80px] pr-8">
                    <div className="flex flex-col gap-[8px]">
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {/* Genre + Status Pills */}
                            <span className="inline-flex items-center gap-1 text-[10px] font-medium px-2.5 py-0.5 rounded-full border bg-secondary/15 text-secondary border-secondary/20">
                                {album?.genre}
                            </span>
                            <AlbumStatusBadge status={status} className="text-[10px]" />
                        </div>
