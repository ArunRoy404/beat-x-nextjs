...
const AlbumDetailFooter = ({ album, onClose }) => {
    ...
    const updateAlbum = useArtistAlbumsStore((state) => state.updateAlbum)
            ...
            <div className="flex items-center justify-between w-full flex-wrap gap-3">
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        ...
                        className={`font-medium rounded-[10px] px-4 h-10 flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-95 border ${album?.status === "Published"
