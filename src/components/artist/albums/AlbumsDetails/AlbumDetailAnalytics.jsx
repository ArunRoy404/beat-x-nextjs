...
import { useArtistSongDetailsAnalyticsStore } from "@/zustandStore/artist/artistStore/artistSongDetailsAnalyticsStore"
import DashboardStats from "@/components/shared/Dashboard/DashboardStats/DashboardStats"
import { ResponsiveContainer, AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip } from "recharts"

const AlbumDetailAnalytics = () => {
    const songStatsCards = useArtistSongDetailsAnalyticsStore((state) => state.songStatsCards)
    const songPerformanceData = useArtistSongDetailsAnalyticsStore((state) => state.songPerformanceData)
    const songPlatformData = useArtistSongDetailsAnalyticsStore((state) => state.songPlatformData)
    const songCountryData = useArtistSongDetailsAnalyticsStore((state) => state.songCountryData)
...
export default AlbumDetailAnalytics
