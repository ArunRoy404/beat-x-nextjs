...
const ProductsContainer = () => {
  const productsList = useArtistShopStore((state) => state.productsList)
  const selectedStatusFilter = useArtistShopStore((state) => state.selectedStatusFilter)
  const setSelectedStatusFilter = useArtistShopStore((state) => state.setSelectedStatusFilter)
  const searchQuery = useArtistShopStore((state) => state.searchQuery)
  const setSearchQuery = useArtistShopStore((state) => state.setSearchQuery)
  const currentPage = useArtistShopStore((state) => state.currentPage)
  const setCurrentPage = useArtistShopStore((state) => state.setCurrentPage)
