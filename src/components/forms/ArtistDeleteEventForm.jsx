...
const ArtistDeleteEventForm = ({ event, onSuccess, onCancel }) => {
    const deleteEvent = useArtistEventsStore((state) => state.deleteEvent)
...
export default ArtistDeleteEventForm
