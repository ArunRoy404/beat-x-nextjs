...
const ArtistDeletePayoutHistoryForm = ({ entry, onSuccess, onCancel }) => {
    const deletePayoutHistoryEntry = useArtistPayoutStore((state) => state.deletePayoutHistoryEntry)
    ...
    const onSubmit = (data) => {
        ...
        deletePayoutHistoryEntry(entry.id)
        toast.success("Payout history entry deleted successfully!")
        onSuccess?.()
    }
        ...
        <CommonFormContainer onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-4">
                <p className="text-light-whitetext text-[14px] not-italic font-normal leading-[22px] font-sans">
                    You are about to permanently delete this History. This action cannot be undone.
                </p>
                <p className="text-light-whitetext text-[14px] not-italic font-normal leading-[22px] font-sans">
...
export default ArtistDeletePayoutHistoryForm
