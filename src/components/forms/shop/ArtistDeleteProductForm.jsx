...
const ArtistDeleteProductForm = ({ product, onSuccess, onCancel }) => {
    const deleteProduct = useArtistShopStore((state) => state.deleteProduct)
...
export default ArtistDeleteProductForm
