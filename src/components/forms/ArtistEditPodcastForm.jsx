...
const ArtistEditPodcastForm = ({ podcast, onSuccess, onCancel }) => {
    const updatePodcast = useArtistPodcastsStore((state) => state.updatePodcast)
...
export default ArtistEditPodcastForm
