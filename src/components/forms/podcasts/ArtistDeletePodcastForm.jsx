...
const ArtistDeletePodcastForm = ({ podcast, onSuccess, onCancel }) => {
    const deletePodcast = useArtistPodcastsStore((state) => state.deletePodcast)
        ...
        <CommonFormContainer onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-4">
                <p className="text-light-whitetext text-[14px] not-italic font-normal leading-[22px] font-sans">
                    You are about to permanently delete this Podcast. This action cannot be undone.
                </p>
                <p className="text-light-whitetext text-[14px] not-italic font-normal leading-[22px] font-sans">
...
export default ArtistDeletePodcastForm
