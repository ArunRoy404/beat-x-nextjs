...
const ArtistDeleteTransactionForm = ({ transaction, onSuccess, onCancel }) => {
    const deleteTransaction = useArtistRevenueStore((state) => state.deleteTransaction)
        ...
        <CommonFormContainer onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-col gap-4">
                <p className="text-light-whitetext text-[14px] not-italic font-normal leading-[22px] font-sans">
                    You are about to permanently delete this Transaction History. This action cannot be undone.
                </p>
                <p className="text-light-whitetext text-[14px] not-italic font-normal leading-[22px] font-sans">
...
export default ArtistDeleteTransactionForm
