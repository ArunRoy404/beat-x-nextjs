...
const ArtistUploadNewSongForm = ({ onSuccess, onCancel }) => {
    const addSong = useArtistMusicStore((state) => state.addSong)
    ...
    const {
        ...
        defaultValues: { ...uploadSongDefaultValues, artist: "TAHSIN" },
    })
...
export default ArtistUploadNewSongForm
