...
import { DEFAULT_SONGS_PARAMS } from "@/hooks/api/admin/songs/useSongs";
...
const page = async () => {
  ...
  await queryClient.prefetchQuery({
    queryKey: queryKeys.music.list(DEFAULT_SONGS_PARAMS),
    queryFn: () => getSongsRequest(DEFAULT_SONGS_PARAMS),
  });
